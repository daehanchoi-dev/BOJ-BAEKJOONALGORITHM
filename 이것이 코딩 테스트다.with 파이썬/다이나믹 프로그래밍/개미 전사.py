...
메뚜기 마을에는 여러 개의 식량창고가 있는데 식량창고는 이직선으로 이어져 있다.
...
예를 들어 식량창고가 [1, 3, 4, 5] 와 같이 있다면 개미 전사는 두 번째와 네 번째 창고를 선택하여 최댓값인 총 8개의 식량을 빼앗을 수 있다.
...
for i in range(2, N):
    ...
    print('d[',i,']=',d[i], '\t d[',i-1,']=',d[i-1], '\t d[',i-2,']=',d[i-2], '\t warehouse[',i,']=',warehouse[i])
